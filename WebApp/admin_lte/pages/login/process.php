<?php
  ...
  if (isset($_POST['user']) and isset($_POST['pass'])){
    ...
    $password = $_POST['pass'];
      ...
      // Checking for admin page:
      if($username == "admin" && $password == "admin"){
          $_SESSION['username'] = $username;
          $_SESSION['kiosk_id']= 6;
          header("Location: ../admin/pages/dashboard2/");
          exit;
      }else{
          $fmsg = "Ошибка";
        ...
        // Checking for admin lite page:
      if($username == "lite" && $password == "lite"){
          $_SESSION['username'] = $username;
          $_SESSION['kiosk_id']= 6;
          header("Location: ../admin_lite/pages/dashboard2/");
          exit;
      }else{
          $fmsg = "Ошибка";
          header("Location: index.php");
