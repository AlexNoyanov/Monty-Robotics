...
function GetTableData($kioskName){
 ...
 function getColor($orderDate) {
  ...
  // $tDateOrder = strtotime($orderDate);
  // echo "<br> Date order:".$orderDate;
  // $diffDate = floor(abs($timeNow - $tDateOrder)/3600);

  // Find time difference:
  // $dateDiff = round((strtotime($timeNow) - strtotime($orderDate))/3600, 1);

  // echo "<br> Date diff:".$diffDate;
  // echo "<br> Date diff2:".$dateDiff;
