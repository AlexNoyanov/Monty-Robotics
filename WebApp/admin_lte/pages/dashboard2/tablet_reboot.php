...
if (isset($_POST['kiosk_id'])){
    $tablet_left = $_POST['tablet_left'];
	$tablet_right = $_POST['tablet_right'];
    ...
    $query = "UPDATE kiosk SET tablet_left='$tablet_left', tablet_right='$tablet_right'  WHERE kiosk_id='$kiosk_id'";
