...
if (isset($_POST['kiosk_id'])){
    $state_left = $_POST['pay_left'];
    $state_right = $_POST['pay_right'];
    ...
    $query = "UPDATE kiosk SET  returm_pay_left ='$state_left',  returm_pay_right='$state_right'  WHERE kiosk_id='$kiosk_id'";
