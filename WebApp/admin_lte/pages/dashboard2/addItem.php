...
$sql = "UPDATE assortment SET product_mass = '$itemMass', description = '$itemDesc', price = '$itemPrice', product_title_name = '$itemTitle', date = '$date' , active = '$active' WHERE product_id = '$itemID' ";
